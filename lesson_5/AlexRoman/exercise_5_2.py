########################################################################################################
# Exercise 2 Slice
# Slice can be used to get a substring, i.e to get all but last letter my_string[:-1], to get all except 
# the first letter my_string[1:], to get three first letters my_string[:3]
# Docs about slice

...
# 11 Vilken datatyp har variablerna ​numbers1 o​ch ​numbers2?​
print("-----11-----")
print(f"Datatype of numbers1 and numbers2 it's {type(numbers1)} and {type(numbers2)}")
print("------------")
# 12 Vilka värden finns lagrade i variablerna ​numbers1 ​och ​numbers2?​
print("-----12-----")
print(numbers1)
print(numbers2)
print("------------")
...
# 13 Vad är snittet (intersection) mellan variablerna ​numbers1 ​och n​umbers2?​
print("-----13-----")
print(f"Intersection of numbers 1 and 2 is {numbers1 & numbers2}")
print("------------")


# 14 Vad är unionen mellan variablerna ​numbers1 ​och ​numbers2?​
print("-----14-----")
print(f"union between numbers 1 and 2 it's {numbers1 | numbers2}")
print("------------")


# 15 Vilken är den symmetriska differensen mellan ​numbers1 ​och ​numbers2?​
print("-----15-----")
symmetric = numbers1.symmetric_difference(numbers2)
print(f"The symmetric difference is {symmetric}")
print("------------")
